...
Name: "{app}\sendto+\sendto\Process monitors\Process Hacker (x64)"; Filename: "{app}\processhacker\x64\ProcessHacker.exe"; WorkingDir: "{app}\processhacker\x64"; Components: "processmonitors\processhacker"
