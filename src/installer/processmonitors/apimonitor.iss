...
Name: "{app}\sendto+\sendto\Process monitors\API Monitor (x64)"; Filename: "{app}\apimonitor\apimonitor-x64.exe"; WorkingDir: "{app}\apimonitor"; Components: "processmonitors\apimonitor"
