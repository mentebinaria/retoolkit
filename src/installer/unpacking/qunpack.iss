...
Name: "{app}\sendto+\sendto\Unpacking\QuickUnpack (x86)"; Filename: "{app}\qunpack\QUnpack32\Explorer.exe"; WorkingDir: "{app}\qunpack\QUnpack32"; Components: "unpacking\qunpack"
...
Name: "{app}\sendto+\sendto\Unpacking\QuickUnpack (x64)"; Filename: "{app}\qunpack\QUnpack64\Explorer.exe"; WorkingDir: "{app}\qunpack\QUnpack64"; Components: "unpacking\qunpack"