...
Name: "{group}\{#MyAppName}\dnSpy (x64)"; Filename: "{app}\dotnet\dnSpy\dnSpy.exe"; Components: "dotnet\dnspy"; Check: Is64BitInstallMode
Name: "{app}\sendto+\sendto\Dotnet\dnSpy (x64)"; Filename: "{app}\dotnet\dnSpy\dnSpy.exe"; Components: "dotnet\dnspy"; Check: Is64BitInstallMode